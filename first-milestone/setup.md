...
##	You can either download [Scala distro](https://downloads.lightbend.com/scala/2.12.2/scala-2.12.2.zip) and use [REPL](http://docs.scala-lang.org/overviews/repl/overview.html)
##	Or you can do complete Scala Eevelopment Enviornment setup using Eclipse IDE and Scala SBT
